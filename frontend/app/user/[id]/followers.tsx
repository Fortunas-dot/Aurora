...
export default function FollowersScreen() {
  ...
  const loadFollowers = useCallback(async (pageNum: number = 1, append: boolean = false) => {
    if (!id) return;

    try {
      const response = await userService.getFollowers(id, pageNum, 20);
